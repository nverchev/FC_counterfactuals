...
import numpy as np
import os
from options import parse_ae_args
from src.dataset import get_loaders
from src.optim import get_opt, CosineSchedule
from src.trainers import get_ae_trainer
from src.models import get_ae


def main():
    args = parse_ae_args().parse_args()
    exp_name = 'ae' + '_' * bool(args.exp) + args.exp
